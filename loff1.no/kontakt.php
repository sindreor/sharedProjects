...
<html lang="en">
    <head>
        ...
        <META name=author content="Gjert Magne Kahrs Knutsen,  Sindre Osmundsen Rasmussen">
  ...
  fjs.parentNode.insertBefore(js, fjs);
        ...
        <div id="mobillogo"></div>
            ...
            <div id="tekstfelt">
                ...
                $avsnitt=array();
                $bilder=array();
                $omfil = fopen("rediger/RedigerKontakt.txt", "r") or die("Unable to open file!");
                $nr=0;
                while(!feof($omfil)){
               ...
               ?> <BR>
                            ...
                            <iframe src="http://kart.gulesider.no/m/adiLq"name="kart" height="500" width="730" >
